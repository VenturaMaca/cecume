...
## TODOS LOS ARCHIVOS SE PUEDEN ENCONTRAR EN
- **2025**: https://drive.google.com/drive/folders/1Nb-EwnZ3gc2HhtStkr9hiU0hfvnRXR0X?usp=sharing
- **2026**: https://drive.google.com/drive/folders/15HPNALHpkxw1LEI-mdXrP-3Mjd-345GF?usp=sharing


## 📦 Instalación y Uso
1. Clona el repositorio:
   ```sh
   git clone https://github.com/VenturaMaca/cecume.git
   ```
